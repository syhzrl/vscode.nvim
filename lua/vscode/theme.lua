...
theme.set_highlights = function(opts)
    ...
    hl(0, 'Normal', { fg = c.vscFront, bg = c.vscNone })
    ...
    hl(0, 'VertSplit', { fg = c.vscBlueGreen, bg = c.vscBack })
    ...
    hl(0, 'SignColumn', { fg = 'NONE', bg = c.vscNone })
    hl(0, 'IncSearch', { fg = c.vscNone, bg = c.vscSearchCurrent })
    -- hl(0, 'LineNr', { fg = c.vscLineNumber, bg = c.vscBack })
    -- hl(0, 'CursorLineNr', { fg = c.vscBlueGreen, bg = c.vscBack })
    hl(0, 'LineNr', { fg = c.vscLineNumber, bg = c.vscNone })
    hl(0, 'CursorLineNr', { fg = c.vscBlueGreen, bg = c.vscNone })
    ...
    hl(0, 'FloatBorder', { fg = c.vscBlueGreen, bg = c.vscPopupBack })
    ...
    hl(0, 'NeoTreeNormal', { bg = c.vscBack })
    hl(0, 'NeoTreeNormalNC', { bg = c.vscBack })
    hl(0, 'NeoTreeFileName', { bg = c.vscNone, fg = c.vscNone })
    hl(0, 'NeoTreeDirectoryName', { bg = c.vscNone, fg = c.vscFront })
    hl(0, 'NeoTreeDirectoryIcon', { bg = c.vscNone, fg = c.vscMediumBlue })
    ...
    -- Trouble
    hl(0, 'TroubleNormal', { bg = c.vscBack })
    hl(0, 'TroubleNormalNC', { bg = c.vscBack })
    ...
    if isDark then
        ...
        hl(0, 'LspFloatWinNormal', { fg = c.vscBack, bg = 'NONE' })
        hl(0, 'LspFloatWinBorder', { fg = c.vscBlueGreen, bg = 'NONE' })
        hl(0, 'LspInfoBorder', { fg = c.vscBlueGreen, bg = 'NONE' })
        ...
        hl(0, 'TelescopePromptBorder', { fg = c.vscBlueGreen, bg = c.vscBack })
        hl(0, 'TelescopeResultsBorder', { fg = c.vscBlueGreen, bg = c.vscBack })
        hl(0, 'TelescopePreviewBorder', { fg = c.vscBlueGreen, bg = c.vscBack })
        -- hl(0, 'TelescopeNormal', { fg = c.vscFront, bg = opts.disable_telescope_bg and c.vscBack or c.vscLeftDark })
        hl(0, 'TelescopeNormal', { fg = c.vscFront, bg = c.vscBack })
